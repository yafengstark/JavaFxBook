...
public class TaskCellFactory implements Callback<TreeView<TaskNode>, TreeCell<TaskNode>> {
    ...
    private static final Image TASKS_IMAGE = new Image(TaskCellFactory.class.getResource("tasks.png").toExternalForm());
    private static final Image PIN_IMAGE = new Image(TaskCellFactory.class.getResource("pin.png").toExternalForm());
